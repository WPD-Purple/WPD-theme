...
add_action( 'widgets_init', '_s_widgets_init1' );

function _s_widgets_init2() {
	register_sidebar( array(
		'name'          => __( 'フッター2', '_s' ),
		'id'            => 'footer2',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
...
add_action( 'widgets_init', '_s_widgets_init2' );

function _s_widgets_init3() {
	register_sidebar( array(
		'name'          => __( 'フッター3', '_s' ),
		'id'            => 'footer3',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
...
add_action( 'widgets_init', '_s_widgets_init3' );
